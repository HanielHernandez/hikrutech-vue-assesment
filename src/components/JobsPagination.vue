...
<template>
  <div class="flex flex-row justify-between w-full max-w-3xl mx-auto py-4">
    <div>
      <JButton id="first_page" @click="onButtonClick('start')" class="mr-4" title="First Page" :disabled="page === 1">
        <span class="material-icons">
          first_page
        </span>
      </JButton>
      <JButton id="prev_page" @click="onButtonClick('prev')" title="Previous" :disabled="page === 1">
        <span class="material-icons">
          chevron_left
        </span>
      </JButton>
    ...
    {{ page + "/" + totalPages }}
    <div>
      <JButton id="next_page" @click="onButtonClick('next')" title="Next" class="mr-4" :disabled="endReached">
        <span class="material-icons">
          chevron_right
        </span>
      </JButton>
      <JButton id="last_page" @click="onButtonClick('last')" title="Last Page" :disabled="endReached">
        <span class="material-icons">
          last_page
        </span>
      </JButton>
